...
<li><label for="commento">Commento:</label><br/><span><textarea  placeholder="Inserisci un commento" rows="2" cols="40"  id="commento" name="insertcommento" maxlength="200"><areacom/></textarea></span></li>

...
$contenuto.='<label id="aggiungi_commento" class="formdesc">Ti è consentito lasciare un solo commento per ogni ambito delle classe di laurea per le quali ti sei dichiarato iscritto. </label>';
...
<li><label for="p_acc_fisica">Punteggio accessibilità fisica:</label><span><input title="valutazione che riguarda la possibilità da parte di chiunque di fruire dei servizi universitari da un punto di vista fisico" type="number" id="p_acc_fisica" name="p_acc_fisica" placeholder="1" value="1" min="1" max="5" 
   /></span></li>
    
<li><label for="p_inclusione">Punteggio servizio inclusione:</label><span><input title="valutazione riguardante l\'accoglienza e l\'appartenenza ad un gruppo universitario" type="number" id="p_inclusione" name="p_inclusione" placeholder="1" value="1" min="1" max="5" 
    /></span></li>
    
<li><label for="p_tempestivita">Punteggio tempestivita burocratica: </label><span><input type="number" title="valutazione attinente alla velocità di intervento e risposta da parte dei servizi amministrativi e burocratici universitari" id="p_tempestivita" name="p_tempestivita" placeholder="1" value="1" min="1" max="5" 
    /></span></li>
    
<li><label for="p_insegnamento">Punteggio insegnamento:</label><span><input type="number" title="valutazione riguardante la qualità di insegnamento ricevuto e le competenze acquisite in esso"  id="p_insegnamento" name="p_insegnamento" placeholder="1" value="1" min="1" max="5" 
    /></span></li>
</ul>
